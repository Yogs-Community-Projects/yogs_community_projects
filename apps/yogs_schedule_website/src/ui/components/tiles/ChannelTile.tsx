...
export const TwitchTile: Component<TwitchTileProps> = props => {
  ...
  return (
    <a
      ...
      class={
        'hover:scale-102 hover:brightness-102 bg-twitch flex aspect-square flex-col items-center overflow-hidden rounded-3xl p-1 text-white transition-all'
      }
    >
...
export const YoutubeTile: Component<YoutubeTileProps> = props => {
  ...
  return (
    <a
      ...
      class={
        'hover:scale-102 hover:brightness-102 bg-youtube flex aspect-square flex-col items-center overflow-hidden rounded-3xl p-1 text-white transition-all'
      }
    >
      <div class={'h-[75%] object-contain'}>
        <img
