...
export const CreatorLinkButton: Component<CreatorLinkButtonProps> = props => {
  ...
  return (
    <a
      ...
      class={
        'hover:scale-101 inline-flex w-full items-center justify-between rounded-full px-4 py-2 font-bold text-gray-800 no-underline transition-all hover:brightness-105'
      }
    >
      <p>{link.name}</p>
      {icon}
