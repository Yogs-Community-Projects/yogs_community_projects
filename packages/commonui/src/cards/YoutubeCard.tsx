...
export const YoutubeChannelCard: Component<YoutubeChannelCardProps> = props => {
  ...
  return (
    <a
      class="bg-youtube hover:scale-101 my-auto flex aspect-[8/1] w-full rounded-2xl p-2 text-white no-underline transition-all hover:text-white hover:brightness-105"
